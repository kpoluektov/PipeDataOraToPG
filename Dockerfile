...
COPY --from=builder /target/pipe-1.0.0.jar /app/pipe-1.0.0.jar
...
CMD exec java -Dconfig.path=/config -classpath /app/pipe-1.0.0.jar org.pipeoratopg.PipeBySizeDesc
