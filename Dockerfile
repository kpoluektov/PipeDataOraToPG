...
COPY --from=builder /target/pipe-1.2.1.jar /app/pipe-1.2.1.jar
...
CMD exec java -Dconfig.path=/config -classpath /app/pipe-1.2.1.jar org.pipeoratopg.PipeBySizeDesc
